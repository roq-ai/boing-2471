...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'end_user.count', 'health_coach.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('end_user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>end_user</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('end_user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.end_user}</Td>
                    )}
                    {hasAccess('health_coach', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
